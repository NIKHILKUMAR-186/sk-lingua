...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Book 1-on-1 video lessons with real human mentors around the world. Build daily streaks and level up any language." },
      { property: "og:title", content: "Lingua — Learn a language from a real human" },
      { property: "og:description", content: "Book 1-on-1 video lessons with real human mentors and build daily streaks." },
