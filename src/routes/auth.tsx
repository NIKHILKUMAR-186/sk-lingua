        ...
        <section className="rounded-[2rem] bg-hero-gradient from-slate-950  via-slate-900 to-slate-800 p-12 text-white shadow-2xl shadow-slate-950/20">
          <div className="max-w-xl">
            ...
            <p className="mt-6 max-w-md text-lg leading-8 text-slate-300">
              Create your Lingua student account and start your path to fluency with verified
              mentors.
            </p>
            <div className="mt-10 grid gap-4 sm:grid-cols-2">
              <div className="rounded-3xl border border-white/10 bg-white/5 p-5">
                ...
                <p className="mt-3 text-base text-slate-100">
                  Complete the setup and start using LINGUA in minutes.
                </p>
              </div>
              <div className="rounded-3xl border border-white/10 bg-white/5 p-5">
                ...
                <p className="mt-3 text-base text-slate-100">
                  Start as a student and let our team manage mentor applications separately.
                </p>
              </div>
            </div>
          </div>
            ...
            <CardHeader className="space-y-2">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription>
                    Login or create an account to continue your Lingua journey.
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
...
function getSignupErrorMessage(error: unknown): string {
  ...
  if (message.includes("profile"))
    return "Your account was created, but profile creation failed. Please try again.";
  ...
  if (status >= 500)
    return "The authentication server encountered an error. Please try again shortly.";
