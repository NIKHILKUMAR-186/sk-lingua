          ...
          <div className="rounded-lg border p-4">
            ...
            {step === 2 && (
              <div className="space-y-3">
                ...
                <Input
                  value={(draft.teaching_languages ?? []).join(", ")}
                  onChange={(e) =>
                    update(
                      "teaching_languages",
            ...
            {step === 3 && (
              <div className="space-y-3">
                ...
                <Textarea
                  value={draft.why_apply ?? ""}
                  onChange={(e) => update("why_apply", e.target.value)}
                />
                <Label>Teaching methodology</Label>
                <Textarea
                  value={draft.teaching_methodology ?? ""}
                  onChange={(e) => update("teaching_methodology", e.target.value)}
                />
                <div className="flex gap-2 mt-4">
