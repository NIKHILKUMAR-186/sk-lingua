...
const MentorAnalyticsDashboard = React.lazy(() =>
  import("@/components/mentor-analytics-dashboard").then((m) => ({
    default: m.MentorAnalyticsDashboard,
  })),
);
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                A fuller profile helps students trust your teaching profile.
              </p>
            </CardContent>
          </Card>
          <Card>
            ...
            <CardContent className="grid gap-3 sm:grid-cols-3">
              <div className="rounded-lg border p-3">
                ...
                <div className="text-xl font-semibold">{studentsTaught}</div>
              </div>
              <div className="rounded-lg border p-3">
              ...
              <div className="rounded-lg border p-3">
                <div className="text-xs text-muted-foreground">Homework shared</div>
                <div className="text-xl font-semibold">{homeworkShared}</div>
              </div>
            </CardContent>
          </Card>
        </div>
          ...
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Button variant="ghost" size="sm" asChild>
              <Link to="/mentor/resources">
                Manage resources <ArrowRight className="ml-1 h-3 w-3" />
              </Link>
            </Button>
          </CardHeader>
          <CardContent className="space-y-3">
                ...
                >
                  <div>
                    ...
                    <div className="text-xs text-muted-foreground">
                      {resource.visibility} • {resource.file_name ?? resource.url}
                    </div>
                  </div>
